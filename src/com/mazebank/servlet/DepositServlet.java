 ...
 * POST /api/deposit?accountId=id&amount=amount&description=desc
 */
public class DepositServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (accountDAO.updateBalance(accountId, newBalance)) {
                    // Record transaction
                    Transaction transaction = new Transaction(null, accountId, "DEPOSIT", amount, description != null ? description : "Deposit");
                    ...
                    successResponse.put("message", "Deposit successful");
                    ...
                    Map<String, Object> errorResponse = new HashMap<>();
                    errorResponse.put("success", false);
                    errorResponse.put("message", "Failed to process deposit");
                    out.print(objectMapper.writeValueAsString(errorResponse));
                }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        msg.put("message", "Use POST method to deposit");
